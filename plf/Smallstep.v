...
Proof.
  ...
  intros y2 Hy2;inversion Hy2;subst;simpl in *;
...
Proof.
  ...
  inversion P1 as [H1 Ps1]; clear P1.
  inversion P2 as [H2 Ps2]; clear P2.
  generalize dependent y2.
  induction H1;intros y2 H2 Ps2. 
  - unfold step_normal_form, normal_form in Ps1.
    inversion H2.
    + reflexivity.
    + exfalso; apply Ps1.
      exists y; assumption.
  - inversion H2.
    + unfold step_normal_form, normal_form in Ps2.
      rewrite H3 in H.
      exfalso. apply Ps2.
      exists y;assumption.
    + subst.
...
Proof.
  ...
  induction Hs;intros n HBs.
  - inversion HBs.
    apply E_Plus;constructor.
  - inversion HBs;subst.
    apply E_Plus. apply IHHs. apply H1.
    apply H3.
  - inversion HBs;subst.
...
Proof.
  ...
  intros t t' [HMs Hnorm].
  induction HMs.
  - apply nf_same_as_value in Hnorm.
    inversion Hnorm.
    exists n;split.
    + reflexivity.
    + apply E_Const.
  - apply IHHMs in Hnorm as Q.
    apply nf_same_as_value in Hnorm.
    inversion Hnorm;subst.
    exists n. split.
    + reflexivity.
    + destruct Q as [m [Eq H']]. injection Eq as Eq.
      rewrite <- Eq in H'. clear Hnorm Eq.
...
Proof.
  intros n st [Hxvar Hyvar]. unfold par_loop.
  eapply multi_step. apply CS_Par2. apply CS_While.
  eapply multi_step. apply CS_Par2. apply CS_IfStep.
    apply BS_Eq1. apply AS_Id.
  eapply multi_step. apply CS_Par2. apply CS_IfStep.
    rewrite Hyvar. apply BS_Eq.
...
Definition compiler_is_correct_statement : Prop :=
  forall a st, stack_multistep st ((s_compile a), nil) (nil, [aeval st a]).
